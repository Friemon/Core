Contributing to Friemon Core
============================

The Friemon Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Friemon Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/friemon-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to friemon-qt
...
The following applies to code changes to the Friemon Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Friemon
Network Protocol consensus changes.

Whether a pull request is merged into Friemon Core rests with the project merge
...
Patches that change Friemon consensus rules are considerably more involved than
...
Where a patch set proposes to change the Friemon consensus, it must have been
...
The project leader is the release manager for each Friemon Core release.
