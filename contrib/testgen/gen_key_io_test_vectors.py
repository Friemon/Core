...
bech32_templates = [
  ...
  ('frmn',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('frmn',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('frmn',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('frmn',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tfrmn',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tfrmn',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tfrmn',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tfrmn',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tfrmn',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tfrmn',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tfrmn',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tfrmn',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rfrmn',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rfrmn',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rfrmn',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rfrmn', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tfrmn',   17, 32, Encoding.BECH32M, False, False, False),
  ('rfrmn',  3,  1, Encoding.BECH32M, False, False, False),
  ('frmn',   15, 41, Encoding.BECH32M, False, False, False),
  ('tfrmn',    0, 16, Encoding.BECH32,  False, False, False),
  ('rfrmn',  0, 32, Encoding.BECH32,  True,  False, False),
  ('frmn',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tfrmn',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rfrmn',  0, 20, Encoding.BECH32,  False, False, True),
  ('frmn',    0, 20, Encoding.BECH32M, False, False, False),
  ('tfrmn',    0, 32, Encoding.BECH32M, False, False, False),
  ('rfrmn',  0, 20, Encoding.BECH32M, False, False, False),
  ('frmn',    1, 32, Encoding.BECH32,  False, False, False),
  ('tfrmn',    2, 16, Encoding.BECH32,  False, False, False),
  ('rfrmn', 16, 20, Encoding.BECH32,  False, False, False),
]
