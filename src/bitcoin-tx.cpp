...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " friemon-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  friemon-tx [options] <hex-tx> [commands]  Update hex-encoded friemon transaction\n" +
            "or:     friemon-tx [options] -create [commands]   Create hex-encoded friemon transaction\n" +
            "\n";
