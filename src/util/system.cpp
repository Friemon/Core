...
const char * const BITCOIN_CONF_FILENAME = "friemon.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Friemon";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Friemon";
#else
    // Unix-like
    return pathRet / ".friemon";
#endif
#endif
}
