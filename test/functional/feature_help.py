...
"""Verify that starting friemon with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start friemon with -h for help text")
        ...
        self.log.info("Start friemon with -version for version information")
        ...
        self.log.info("Start friemond with -fakearg to make sure it does not start")
