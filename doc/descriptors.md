# Support for Output Descriptors in Friemon Core

Since Friemon Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `frmn1...` for mainnet or `tfrmn1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Friemon Core wallets, a convenience function `combo` is
