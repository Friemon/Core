...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Friemon Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Friemon Core"
...
#define PACKAGE_NAME "Friemon Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Friemon Core 0.21.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "friemon"
